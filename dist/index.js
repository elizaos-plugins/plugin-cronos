...
var require_clone = __commonJS({
  "../../node_modules/node-cache/node_modules/clone/clone.js"(exports, module) {
    var clone = function() {
      "use strict";
...
var require_node_cache = __commonJS({
  "../../node_modules/node-cache/lib/node_cache.js"(exports, module) {
    (function() {
      ...
      module.exports = NodeCache2 = function() {
...
var require_node_cache2 = __commonJS({
  "../../node_modules/node-cache/index.js"(exports, module) {
    (function() {
      var exports2;
...
// src/providers/wallet.ts
var CronosWalletProvider = class {
  constructor(accountOrPrivateKey, cacheManager) {
    this.cacheManager = cacheManager;
    this.setAccount(accountOrPrivateKey);
    this.cache = new import_node_cache.default({ stdTTL: this.CACHE_EXPIRY_SEC });
  }
  cache;
  cacheKey = "cronos/wallet";
  currentChain = "cronos";
  CACHE_EXPIRY_SEC = 5;
  chains = {
    cronos,
...
var initCronosWalletProvider = async (runtime) => {
...
var transferTemplate = `You are a helpful assistant that helps users transfer CRO tokens on the Cronos chain.
...
var balanceTemplate = `You are a helpful assistant that helps users check their CRO token balance on the Cronos chain.
...
var BalanceSchema = z.object({
  ...
  address: z.string().refine((val) => isAddress2(val), {
...
var buildBalanceDetails = async (state, runtime, _wp) => {
  state.supportedChains = '"cronos"|"cronosTestnet"';
  const context = composeContext2({
    state,
    template: balanceTemplate
  });
  const balanceDetails = (await generateObject2({
    runtime,
    context,
...
var index_default = cronosPlugin;
export {
  BalanceAction,
  BalanceParamsSchema,
  CronosWalletProvider,
  TransferAction,
  balanceAction,
  cronosPlugin,
  cronosWalletProvider,
  index_default as default,
  initCronosWalletProvider,
  transferAction
};
